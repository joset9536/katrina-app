...
// Deterministic pseudo-random layout so it doesn't reshuffle on every render.
...
/**
 * Sitewide floating neon dots — fixed, behind content, covers full viewport
 * height so it reads as ambient sparkle no matter where you scroll.
 */
